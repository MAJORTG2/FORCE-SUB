        ...
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   ...
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/MLZ_BOTZ).",
                   parse_mode="markdown",
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                           InlineKeyboardButton("Join Updates Channel", url="https://t.me/MLZ_BOTZ"),
                           InlineKeyboardButton("Support Group", url="https://t.me/MLZ_BOTZ")
                      ],
                     [
                           InlineKeyboardButton("🧑‍💻Devloper🧑‍💻", url="https://t.me/MLZ_BOTZ")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
async def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Souce Code", url="https://t.me/MLZ_BOTZ")
                ],
                [
                    InlineKeyboardButton("Join Updates Channel", url="https://t.me/MLZ_BOTZ"),
                    InlineKeyboardButton("Support Group", url="https://t.me/MLZ_BOTZ")
